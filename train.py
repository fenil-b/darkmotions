...
from option import *
from utils import *
from modeling.rrdnet_semi import *
...
class Trainer():
    ...
    def get_loss(self, A, enhanced_image, img_lowlight, E):
        ...
        loss = 0.45 * Loss_TV + 0.15 * loss_spa + 0.15 * loss_col + 0.15 * loss_exp + 0.1 * loss_seg
    ...
    def train(self):
        ...
        for epoch in range(self.num_epochs):
            ...
            for iteration, img_lowlight in enumerate(self.train_loader):
                ...
                enhanced_image1, A = self.net(img_lowlight)
                enhanced_image = retinex(semi_net, enhanced_image1)
